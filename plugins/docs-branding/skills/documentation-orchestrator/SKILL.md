...
| Skill | Output | Scope |
|---|---|---|
| `backend-documentation` | `backend-doc.tex` | Architecture, API, DB, security, logging, integrations |
| `frontend-documentation` | `frontend-doc.tex` | Angular architecture, components, NgRx, routing, design |
