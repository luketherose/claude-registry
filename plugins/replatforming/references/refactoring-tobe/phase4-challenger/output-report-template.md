...
- [Goal](#goal): what this file provides, including one example finding per check.
- [File 1: `docs/refactoring/_meta/challenger-report.md`](#file-1-docsrefactoring_metachallenger-reportmd): the full challenger report template.
- [File 2: `.refactoring-kb/02-traceability/as-is-to-be-matrix.json`](#file-2-refactoring-kb02-traceabilityas-is-to-be-matrixjson): the traceability matrix, whose schema lives in the checklist reference.
- [File 3: appended section in `.refactoring-kb/_meta/unresolved-tobe.md`](#file-3-appended-section-in-refactoring-kb_metaunresolved-tobemd): the block appended to the unresolved file, and what to do when the heading already exists.
