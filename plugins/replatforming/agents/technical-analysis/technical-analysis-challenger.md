...
| Doc | Read when |
|---|---|
| `${CLAUDE_PLUGIN_ROOT}/references/technical-analysis/technical-analysis-challenger/output-templates.md` | About to write `_meta/challenger-report.md` or append to `14-unresolved-questions.md`; also for the Streamlit Check 6 detailed checklist |
...
→ Read `${CLAUDE_PLUGIN_ROOT}/references/technical-analysis/technical-analysis-challenger/output-templates.md`
