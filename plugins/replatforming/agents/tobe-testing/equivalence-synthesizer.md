...
`${CLAUDE_PLUGIN_ROOT}/references/tobe-testing/equivalence-synthesizer/` and are read on
...
→ Read `${CLAUDE_PLUGIN_ROOT}/references/tobe-testing/equivalence-synthesizer/equivalence-report-template.md`
when writing the deliverable (full structure + verdict classification table).

→ Read `${CLAUDE_PLUGIN_ROOT}/references/tobe-testing/equivalence-synthesizer/readme-and-context-templates.md`
