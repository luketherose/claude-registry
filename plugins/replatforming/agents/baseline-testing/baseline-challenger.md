...
`${CLAUDE_PLUGIN_ROOT}/references/baseline-testing/baseline-challenger/` and are
...
`${CLAUDE_PLUGIN_ROOT}/references/baseline-testing/baseline-challenger/output-report-template.md`:
