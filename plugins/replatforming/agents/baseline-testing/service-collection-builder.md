...
→ Read `${CLAUDE_PLUGIN_ROOT}/references/baseline-testing/service-collection-builder/postman-template.md`
...
→ Read `${CLAUDE_PLUGIN_ROOT}/references/baseline-testing/service-collection-builder/output-templates.md`
