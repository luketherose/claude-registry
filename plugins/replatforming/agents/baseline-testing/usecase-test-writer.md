...
`${CLAUDE_PLUGIN_ROOT}/references/baseline-testing/usecase-test-writer/` and are read on
...
→ Read `${CLAUDE_PLUGIN_ROOT}/references/baseline-testing/usecase-test-writer/bug-found-policy.md`
