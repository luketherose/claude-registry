...
description: "Use this agent when auditing Phase 0 indexing output quality after the indexing pipeline completes. Reads bronze/, silver/, gold/, graph/, and evidence-ledger.jsonl to find coverage gaps, unverified claims, orphan files, large files without chunk coverage, and AS-IS purity violations. Produces gold/indexing-audit.md and gold/indexing-audit.json with a PASS | PASS_WITH_GAPS | FAIL verdict."
