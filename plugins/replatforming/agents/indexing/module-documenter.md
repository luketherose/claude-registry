...
Read `${CLAUDE_PLUGIN_ROOT}/references/indexing/module-documenter/output-spec.md`
before writing any output. It contains the full Silver JSONL schema,
the Markdown file template, and the output target table.
...
`CHANGELOG.md` (2026-04-28). Allowed Bash usage:
