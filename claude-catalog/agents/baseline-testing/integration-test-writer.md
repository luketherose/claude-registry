...
`claude-catalog/docs/baseline-testing/integration-test-writer/` and are read
on demand.
...
→ Read `claude-catalog/docs/baseline-testing/integration-test-writer/test-module-template.md`
