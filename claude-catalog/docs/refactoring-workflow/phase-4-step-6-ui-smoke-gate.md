...
> non-negotiable: the InfoSync 2026-05 retrospective showed that the
> whole pipeline can declare green (mvn 177/177 + ng test 200/200 +
> equivalence 204/204) while the FE shows the Angular CLI welcome card
> on every route and has no navigation.
